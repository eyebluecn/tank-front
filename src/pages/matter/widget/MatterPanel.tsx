            ...
            <>
                ...
                <Tooltip title={Lang.t('matter.hardDelete')}>
                    <CloseCircleOutlined
                        ...
                        onClick={(e) => SafeUtil.stopPropagationWrap(e)(this.hardDeleteMatter())}
                    />
                </Tooltip>
            </>
        ) : (
        ...
        return (
            <div className="right-part">
                ...
                <Tooltip title={Lang.t('matter.size')}>
                    <span className="matter-size">{StringUtil.humanFileSize(matter.size)}</span>
                </Tooltip>
                {recycleMode ? (
    ...
    getHandles() {
        ...
        if (!matter.dir) {
            handles.push(
                matter.privacy ? (
                    <div
                        className="cell-btn navy"
                        onClick={(e) => SafeUtil.stopPropagationWrap(e)(this.changePrivacy(false))}
                    >
                    ...
                    <div
                        className="cell-btn navy"
                        onClick={(e) => SafeUtil.stopPropagationWrap(e)(this.changePrivacy(true))}
                    >
        ...
        handles.push(
            <div
                className="cell-btn navy"
                onClick={(e) =>
                    SafeUtil.stopPropagationWrap(e)(Sun.navigateTo('/matter/detail/' + matter.uuid))
                }
            >
                <InfoCircleOutlined className="btn-action mr5" />
                {Lang.t('matter.fileDetail')}
        ...
        return (
            <Dropdown overlay={menu} trigger={['contextMenu']}>
                <div className="widget-matter-panel">
                                    ...
                                    {matter.editMode ? (
                                        ...
                                        <span className="matter-name">
                                            ...
                                            {!matter.dir && !matter.privacy && (
                                                <Tooltip
                                                    title={Lang.t(
                                                        'matter.publicFileEveryoneCanVisit',
                                                    )}
                                                >
                    ...
                    <Expanding>{this.showMore ? this.renderMobileOperation() : null}</Expanding>
                </div>
            </Dropdown>
        );
    }
