...
import { CloseOutlined, DownloadOutlined, RotateRightOutlined } from '@ant-design/icons'
...
export default class ImagePreviewer extends React.Component {
  ...
  private static init() {
    ...
    ReactDOM.render(<ImagePreviewer ref={ImagePreviewer.singletonRef} />, document.getElementById('photo-container'))
  }
  ...
  render() {
    let toolBar: (overlayProps: OverlayRenderProps) => React.ReactNode = (overlayProps: OverlayRenderProps) => {
      return (
        <Space>
          <DownloadOutlined
          ...
          />
          <CloseOutlined className="f18 toolbar-icon btn-action" onClick={() => overlayProps.onClose()} />
        </Space>
      )
    }
