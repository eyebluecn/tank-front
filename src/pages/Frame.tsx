...
import NewMatterList from '../pages-hook/matter/List'
...
class RawFrame extends TankComponent<IProps, IState> {
  ...
  initialize() {
    ...
    this.preference.httpFetch(
      function () {
        // 白名单，不要求登录
        let whitePaths = ['/user/login', '/user/register', '/user/authentication']
        // 尝试登录名单，登录失败不做处理
          ...
          <ContentLayout>
            {this.preference.installed ? (
              <div className="pages-content">
                <Route exact path="/" render={() => <Redirect to="/matter/list" />} />
                ...
                <Route exact path="/matter" render={() => <Redirect to="/matter/list" />} />
                ...
                <Route path="/space/:spaceUuid/member" exact component={SpaceMemberList} />
                <Route path="/space/:spaceUuid/matter/list" exact component={SpaceMatterList} />
                <Route path="/space/:spaceUuid/matter/detail/:uuid" exact component={MatterDetail} />

                <Route exact path="/new/matter/list" component={NewMatterList} />
              </div>
            ) : (
              <div className="pages-content">
