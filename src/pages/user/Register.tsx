                ...
                <Row>
                    <Col xs={{span: 24}} md={{span: 8, offset: 6}}>
                        ...
                        >
                            ...
                            >
                                <Input size="large" placeholder={Lang.t("user.enterUsername")}
                                       prefix={<UserOutlined/>}/>
                            </Form.Item>
                            ...
                            >
                                <Input.Password size="large" placeholder={Lang.t("user.enterPassword")}
                                                prefix={<LockOutlined/>}/>
                            </Form.Item>
                            ...
                            >
                                ...
                                <Input.Password size="large" placeholder={Lang.t("user.confirmPassword")}
                                                prefix={<LockOutlined/>}/>
                            </Form.Item>
