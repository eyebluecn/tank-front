                                    ...
                                    <div className="f16">
...

                                        {
                                            (tableInfo.tableExist && tableInfo.missingFields.length === 0) && (
                                                <Tag className="mh5"
                                                     color={Color.SUCCESS}>{Lang.t("install.installed")}</Tag>
                                            )
                                        }

                                        {
                                            (tableInfo.tableExist && tableInfo.missingFields.length > 0) && (
                                                <Tag className="mh5"
                                                     color={Color.DANGER}>{Lang.t("install.installedButMissing")}</Tag>
                                            )
                                        }

                                        {
                                            !tableInfo.tableExist && (
                                                <Tag className="mh5"
                                                     color={Color.WARNING}>{Lang.t("install.toBeInstalled")}</Tag>
                                            )
                                        }
                                    </div>
